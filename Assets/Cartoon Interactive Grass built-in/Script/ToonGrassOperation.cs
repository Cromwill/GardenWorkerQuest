...
[ExecuteInEditMode]
public class ToonGrassOperation : MonoBehaviour
{
    [SerializeField] private ToonGrassPainter toonGrass = default;
    ...
    private UnityEngine.Rendering.ShadowCastingMode castShadow = ShadowCastingMode.Off;
    ...
    private void OnValidate()
    {
        ...
        toonGrass = GetComponent<ToonGrassPainter>();
    ...
    private void OnEnable()
    {
        ...
        if (toonGrass == null || sourceMesh == null || computeShader == null || material == null)
        {
            return;
        }
        sourceMesh = GetComponent<MeshFilter>().sharedMesh;
